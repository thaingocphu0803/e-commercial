         ...
         <div class="row">
                 ...
                 <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__ animate__fadeInUp animated"
                     ...
                     <ul class="contact-infor">
                         <li><svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                 ...
                                 class="text-capitalize">{{ __('custom.address') }}:</strong>&nbsp;<span>{{ $system['contact_address'] }}</span>
                         </li>
                         <li><svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                             ...
                             </svg>&nbsp; <strong class="text-capitalize">{{ __('custom.callUs') }}:
                             </strong>&nbsp;
                             <span dir="ltr">
                                 (+{{ $system['contact_countrycode'] }}) - {{ $system['contact_phone'] }}
                             </span>
                         </li>
                         <li><svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                             ...
                             </svg>&nbsp; <strong class="text-capitalize">{{ __('custom.email') }}:</strong>&nbsp;
                         ...
                         <li><svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                 ...
                                 class="text-capitalize">{{ __('custom.email') }}:</strong>&nbsp;<span>10:00 - 18:00,
                                 {{ __('custom.mon') }} - {{ __('custom.sat') }}</span>
                         </li>
                     </ul>
                 </div>
             </div>
             @foreach ($footerMenu as $menu)
                 <div class="footer-link-widget col wow animate__ animate__fadeInUp animated" data-wow-delay=".3s"
                     ...
                     <h4 class="widget-title">{{ $menu->menuLanguage->name }}</h4>
                     <ul class="footer-list mb-sm-5 mb-md-0">
                         <ul class="footer-list wow fadeIn animated mb-sm-5 mb-md-0 animated"
                             style="visibility: visible;">
                             @foreach ($menu->children as $childMenu)
                                 <li class="">
                                    <a href="{{write_url($childMenu->menuLanguage->canonical, true, true)}}" title="{{$childMenu->menuLanguage->name}}">
                                        <span class="menu-title">{{$childMenu->menuLanguage->name}}</span>
                                        </a>
                                    </li>
                             @endforeach
                         </ul>
