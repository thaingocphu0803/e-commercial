        ...
        <div class="modal-content">
            <div class="wrapper-content">
                <div class="d-flex flex-row justify-content-between">
                    <div class="product-image w-50 d-flex flex-column gap-3 pe-3">
                        ...
                        <div class="image-list d-flex gap-3">
                            ...
                            <div class="list-item">
                                <img src="http://res.cloudinary.com/my-could-api/image/upload/v1752546304/album/variant/imqslgwqj86lhvlue88y.jpg" alt="{{__('custom.productImg')}}"
                                    class="img-cover">
                            </div>
                        </div>
                    </div>
                    <div class="d-flex flex-column gap-1 w-50">
                        <div class="product-title">
                            <h3 class="text-wrap">ssssssssssssss sssssssssssss sssssssssssssss sssss</h3>
                        </div>

                        {{-- start product catalouge --}}
                        <div class="product-catalouge d-flex align-items-center">
                            <span class="me-3 fs-65 text-secondary text-capitalize">{{__('custom.catalouge')}}:</span>
                            <div class="catalouge-list d-flex justify-content-between gap-3">
                                <a href="#" class="list-item">pc</a>
                                <a href="#" class="list-item">lap</a>
                            </div>
                        </div>
                        {{-- end product catalouge --}}

                        {{-- start product variant --}}
                        <div class=" mt-30 border-top border-secondary">
                            <div class="product-variant d-flex flex-column justify-items-center mt-5">
                                <span class="me-3 fs-6 text-secondary text-capitalize">{{__('custom.variant')}}:</span>
                                <div class="variant-list d-flex justify-content-strench gap-3">
                                    <span class="list-item active">pc</span>
                                    <span class="list-item">lap</span>
                                </div>
                            </div>
                        ...
                        <div class=" mt-30 border-top border-secondary text-wrap">
                            <div class="product-description d-flex flex-column justify-items-center mt-5">
                                <span
                        ...
                        <div class=" mt-30 border-top border-secondary justify-self-end">
                            <div class="product-toolbox d-flex  justify-items-between align-items-center mt-5">
                                <div
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <button class="btn fs-6 btn-outline-secondary btn-hande-amount" type="button" id="btn_increase">+</button>
                                    </div>
                                </div>
