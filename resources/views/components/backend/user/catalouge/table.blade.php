    ...
    <table class="table table-striped">
        ...
        <tbody>
            @foreach ($userCatalouges as $userCatalouge)
                <tr>
                    <td><input type="checkbox" name="input" class="checkItem check-table" value="{{$userCatalouge->id}}"></td>
                    ...
                    <td class="js-switch-{{$userCatalouge->id}}">
                        <input
                            ...
                            data-model="userCatalouge"
                            data-field="publish"
                            data-modelId="{{$userCatalouge->id}}"
                            value="{{$userCatalouge->publish}}"
