<x-backend.dashboard.layout>
    ...
    @php
        ...
        $title = isset($attrCatalouge) ? __('form.editObject', ['attribute' => __('dashboard.attrGroup')]) : __('form.addObject', ['attribute' => __('dashboard.attrGroup')]);
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5>
                                {{__('form.chooseObject', ['attribute' => __('form.attrGroupImage')])}}
                            </h5>
                        </div>
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <x-backend.dashboard.form.upload
                                        rowLength="12"
                                        :labelName="__('form.attrGroupImage')"
                                        :value="$attrCatalouge->image ?? '' "
                                    />
                                    <img
                                        class="col-lg-12 hidden"
                                        id="img_show"
                                        :alt="__('form.attrGroupImage')"
                                        height="250px"
                                    >
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 flex flex-col gap-10">
                                    ...
                                    <div class="flex gap-10">
                                        <select name="follow" class="form-control  select2">
                                            <option disabled selected>
                                                 {{__('form.chooseObject', ['attribute' => __('form.attrGroupVision')])}}
                                            </option>
