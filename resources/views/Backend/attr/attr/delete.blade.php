<x-backend.dashboard.layout>
    ...
    <x-backend.dashboard.breadcrumb
        :title="__('form.delObject', ['attribute'=>__('dashboard.attr')])"
    />
            ...
            <div class="row">
                <div class="col-lg-5">
                    <h3 class="panel-title">
                        {{__('form.ObjectInfor', ['attribute' => __('dashboard.attr')])}}
                    </h3>
                    <div class="pannel-description">
                        {{__('form.DelQuestion', ['attribute' => __('dashboard.attr')])}}
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                :labelName="__('dashboard.canonical')"   :value="$attr->canonical ?? ''" :readOnly="true" />
