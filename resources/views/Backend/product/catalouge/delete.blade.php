<x-backend.dashboard.layout>
    ...
    <x-backend.dashboard.breadcrumb
        :title="__('form.delObject', ['attribute'=>__('dashboard.productGroup')])"
    />
            ...
            <div class="row">
                <div class="col-lg-5">
                    <h3 class="panel-title">
                        {{__('form.ObjectInfor', ['attribute' => __('dashboard.productGroup')])}}
                    </h3>
                    <div class="pannel-description">
                        {{__('form.DelQuestion', ['attribute' => __('dashboard.productGroup')])}}
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                :labelName="__('dashboard.canonical')"   :value="$productCatalouge->canonical ?? ''" :readOnly="true" />
