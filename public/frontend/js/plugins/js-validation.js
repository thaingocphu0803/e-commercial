...
function strtotime(e, t) {
    ...
    if ((n = (e = e.replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " ").replace(/[\t\r\n]/g, "").toLowerCase()).match(/^(\d{1,4})([\-\.\/\:])(\d{1,2})([\-\.\/\:])(\d{1,4})(?:\s(\d{1,2}):(\d{2})?:?(\d{2})?)?(?:\s([A-Z]+)?)?$/)) && n[2] === n[4])
        if (n[1] > 1901)
            ...
            switch (n[2]) {
            case "-":
                return n[3] > 12 || n[5] > 31 || n[1] < 70 && n[1] > 38 ? m : (i = n[1] >= 0 && n[1] <= 38 ? +n[1] + 2e3 : n[1],
                new Date(i,parseInt(n[3], 10) - 1,n[5],n[6] || 0,n[7] || 0,n[8] || 0,n[9] || 0) / 1e3);
            case ".":
                return n[5] >= 70 ? n[3] > 12 || n[1] > 31 ? m : new Date(n[5],parseInt(n[3], 10) - 1,n[1],n[6] || 0,n[7] || 0,n[8] || 0,n[9] || 0) / 1e3 : n[5] < 60 && !n[6] ? n[1] > 23 || n[3] > 59 ? m : (r = new Date,
                new Date(r.getFullYear(),r.getMonth(),r.getDate(),n[1] || 0,n[3] || 0,n[5] || 0,n[9] || 0) / 1e3) : m;
            case "/":
                return n[1] > 12 || n[3] > 31 || n[5] < 70 && n[5] > 38 ? m : (i = n[5] >= 0 && n[5] <= 38 ? +n[5] + 2e3 : n[5],
                new Date(i,parseInt(n[1], 10) - 1,n[3],n[6] || 0,n[7] || 0,n[8] || 0,n[9] || 0) / 1e3);
            case ":":
                return n[1] > 23 || n[3] > 59 || n[5] > 59 ? m : (r = new Date,
                new Date(r.getFullYear(),r.getMonth(),r.getDate(),n[1] || 0,n[3] || 0,n[5] || 0) / 1e3)
            }
    if ("now" === e)
        return null === t || isNaN(t) ? (new Date).getTime() / 1e3 | 0 : 0 | t;
    if (!isNaN(a = Date.parse(e)))
        return a / 1e3 | 0;
    ...
    function f(e) {
        ...
        if ("next" === a || "last" === a)
            !function(e, t, a) {
                var n, r = o[t];
                void 0 !== r && (0 == (n = r - s.getDay()) ? n = 7 * a : n > 0 && "last" === e ? n -= 7 : n < 0 && "next" === e && (n += 7),
    ...
    h = "([+-]?\\d+\\s" + (d = "(years?|months?|weeks?|days?|hours?|minutes?|min|seconds?|sec|sunday|sun\\.?|monday|mon\\.?|tuesday|tue\\.?|wednesday|wed\\.?|thursday|thu\\.?|friday|fri\\.?|saturday|sat\\.?)") + "|(last|next)\\s" + d + ")(\\sago)?",
...
!function(e) {
    ...
    e.extend(e.fn, {
        validate: function(t) {
            if (this.length) {
                ...
                a.settings.onsubmit && (this.on("click.validate", ":submit", (function(t) {
                    a.submitButton = t.target,
                    e(this).hasClass("cancel") && (a.cancelSubmit = !0),
                    void 0 !== e(this).attr("formnovalidate") && (a.cancelSubmit = !0)
                }
                )),
                this.on("submit.validate", (function(t) {
                    function n() {
                        var n, r;
                        return a.submitButton && (n = e("<input type='hidden'/>").attr("name", a.submitButton.name).val(e(a.submitButton).val()).appendTo(a.currentForm)),
                        !a.settings.submitHandler || (r = a.settings.submitHandler.call(a, a.currentForm, t),
                        a.submitButton && n.remove(),
                        void 0 !== r && r)
                    }
                    return a.settings.debug && t.preventDefault(),
                    a.cancelSubmit ? (a.cancelSubmit = !1,
                    n()) : a.form() ? a.pendingRequest ? (a.formSubmitted = !0,
                    !1) : n() : (a.focusInvalid(),
                    !1)
                }
                ))),
        ...
        rules: function(t, a) {
            ...
            if (t)
                switch (r = (n = e.data(u.form, "validator").settings).rules,
                ...
                case "add":
                    ...
                    delete i.messages,
                    r[u.name] = i,
                    a.messages && (n.messages[u.name] = e.extend(n.messages[u.name], a.messages));
                    break;
                case "remove":
                    return a ? (l = {},
            ...
            return (s = e.validator.normalizeRules(e.extend({}, e.validator.classRules(u), e.validator.attributeRules(u), e.validator.dataRules(u), e.validator.staticRules(u)), u)).required && (o = s.required,
            delete s.required,
            s = e.extend({
                required: o
            }, s),
    ...
    e.validator.format = function(t, a) {
        return 1 === arguments.length ? function() {
            ...
            return a.unshift(t),
            e.validator.format.apply(this, a)
        }
    ...
    e.extend(e.validator, {
        ...
        prototype: {
            init: function() {
                ...
                e(this.currentForm).on("focusin.validate focusout.validate keyup.validate", ":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'], [type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'], [type='radio'], [type='checkbox']", n).on("click.validate", "select, option, [type='radio'], [type='checkbox']", n),
                this.settings.invalidHandler && e(this.currentForm).on("invalid-form.validate", this.settings.invalidHandler),
                e(this.currentForm).find("[required], [data-rule-required], .required:not(label)").attr("aria-required", "true")
            },
            form: function() {
            ...
            element: function(t) {
                ...
                void 0 === n ? delete this.invalid[a.name] : (this.prepareElement(n),
            ...
            elements: function() {
                ...
                return e(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter((function() {
                    ...
                    !(this.name in a || !t.objectLength(e(this).rules())) && (a[this.name] = !0,
                    !0)
                }
                ))
            },
            ...
            check: function(t) {
                ...
                var a, n, r, i = e(t).rules(), s = e.map(i, (function(e, t) {
                    return t
                }
            ...
            formatAndAdd: function(t, a) {
                var n = this.defaultMessage(t, a.method)
                  , r = /\$?\{(\d+)\}/g;
                "function" == typeof n ? n = n.call(this, a.parameters, t) : r.test(n) && (n = e.validator.format(n.replace(r, "{$1}"), a.parameters)),
                this.errorList.push({
                    message: n,
                    element: t,
                    method: a.method
            ...
            showLabel: function(t, a) {
                var n, r, i, s = this.errorsFor(t), o = this.idOrName(t), l = e(t).attr("aria-describedby");
                s.length ? (s.removeClass(this.settings.validClass).addClass(this.settings.errorClass),
                s.html(a)) : (n = s = e("<" + this.settings.errorElement + ">").attr("id", o + "-error").addClass(this.settings.errorClass).html(a || ""),
                ...
                s.is("label") ? s.attr("for", o) : 0 === s.parents("label[for='" + o + "']").length && (i = s.attr("id").replace(/(:|\.|\[|\]|\$)/g, "\\$1"),
                l ? l.match(new RegExp("\\b" + i + "\\b")) || (l += " " + i) : l = i,
                e(t).attr("aria-describedby", l),
                (r = this.groups[t.name]) && e.each(this.groups, (function(t, a) {
                    a === r && e("[name='" + t + "']", this.currentForm).attr("aria-describedby", s.attr("id"))
                }
                )))),
                !a && this.settings.success && (s.text(""),
            ...
            stopRequest: function(t, a) {
                ...
                a && 0 === this.pendingRequest && this.formSubmitted && this.form() && 0 === this.pendingRequest ? (e(this.currentForm).trigger("submit"),
                this.formSubmitted = !1) : !a && 0 === this.pendingRequest && this.formSubmitted && (e(this.currentForm).triggerHandler("invalid-form", [this]),
        ...
        normalizeAttributeRule: function(e, t, a, n) {
            /min|max/.test(a) && (null === t || /number|range|text/.test(t)) && (n = Number(n),
            isNaN(n) && (n = void 0)),
            n || 0 === n ? e[a] = n : t === a && "range" !== t && (e[a] = !0)
        },
        attributeRules: function(t) {
            var a, n, r = {}, i = e(t), s = t.getAttribute("type");
            for (a in e.validator.methods)
                "required" === a ? ("" === (n = t.getAttribute(a)) && (n = !0),
                n = !!n) : n = i.attr(a),
        ...
        dataRules: function(t) {
            var a, n, r = {}, i = e(t), s = t.getAttribute("type");
            for (a in e.validator.methods)
                n = i.data("rule" + a.charAt(0).toUpperCase() + a.substring(1).toLowerCase()),
                this.normalizeAttributeRule(r, s, a, n);
            return r
        },
        staticRules: function(t) {
            ...
            return n.settings.rules && (a = e.validator.normalizeRule(n.settings.rules[t.name]) || {}),
            a
        },
        normalizeRules: function(t, a) {
            ...
            e.each(["rangelength", "range"], (function() {
                var a;
                t[this] && (e.isArray(t[this]) ? t[this] = [Number(t[this][0]), Number(t[this][1])] : "string" == typeof t[this] && (a = t[this].replace(/[\[\]]/g, "").split(/[\s,]+/),
        ...
        addMethod: function(t, a, n) {
            ...
            a.length < 3 && e.validator.addClassRules(t, e.validator.normalizeRule(t))
        },
        methods: {
            ...
            remote: function(t, a, n) {
                ...
                e.ajax(e.extend(!0, {
                    ...
                    success: function(n) {
                        ...
                        r.settings.messages[a.name].remote = s.originalMessage,
                        u ? (l = r.formSubmitted,
                        r.prepareElement(a),
                        r.formSubmitted = l,
                        ...
                        i[a.name] = s.message = e.isFunction(o) ? o(t) : o,
                        r.invalid[a.name] = !0,
                        r.showErrors(i)),
                        s.valid = u,
                        r.stopRequest(a, u)
...
function(e, t) {
    ...
    return t = {
        ...
        merge: function(e) {
            ...
            a = 1; a < arguments.length; a++)
                if (n = arguments[a])
                    for (var r in n)
                        n.hasOwnProperty(r) && ("object" == typeof n[r] ? t.merge(e[r], n[r]) : e[r] = n[r]);
            return e
        },
    ...
    (e = function(e) {
        ...
        getMonth: function(e) {
            var a;
            return 0 === (a = t.getIndex(e, this.dateSettings.monthsShort) + 1) && (a = t.getIndex(e, this.dateSettings.months) + 1),
            a
        },
        parseDate: function(e, a) {
            var n, r, i, s, o, l, u, d, h, c, m = this, f = !1, g = !1, p = m.dateSettings, v = {
                date: null,
                year: null,
                month: null,
                day: null,
            ...
            for (i = n.length - 1; i >= 0; i--)
                "S" === n[i] && n.splice(i, 1);
            for (r = e.replace(m.separators, "\0").split("\0"),
            i = 0; i < r.length; i++)
                switch (s = r[i],
                o = parseInt(s),
                n[i]) {
                ...
                case "g":
                case "h":
                    if (c = r[u = n.indexOf("a") > -1 ? n.indexOf("a") : n.indexOf("A") > -1 ? n.indexOf("A") : -1],
                    -1 !== u)
                        d = t.compare(c, p.meridiem[0]) ? 0 : t.compare(c, p.meridiem[1]) ? 12 : -1,
                        o >= 1 && o <= 12 && -1 !== d ? v.hour = o % 12 == 0 ? d : o + d : o >= 0 && o <= 23 && (v.hour = o);
                    else {
                        if (!(o >= 0 && o <= 23))
                            return null;
                        v.hour = o
        ...
        guessDate: function(e, t) {
            if ("string" != typeof e)
                return e;
            var a, n, r, i, s, o, l = e.replace(this.separators, "\0").split("\0"), u = t.match(this.validParts), d = new Date, h = 0;
            if (!/^[djmn]/g.test(u[0]))
                return e;
            for (r = 0; r < l.length; r++) {
                ...
                case 2:
                    if (n = d.getFullYear(),
                    h = (a = s.length) < 4 ? a : 4,
                    !(n = parseInt(a < 4 ? n.toString().substr(0, 4 - a) + s : s.substr(0, 4))))
                        return null;
                    d.setFullYear(n);
                    break;
                case 3:
        ...
        parseFormat: function(e, a) {
            var n, r = this, i = r.dateSettings, s = /\\?(.?)/gi, o = function(e, t) {
                return n[e] ? n[e]() : t
            };
            return n = {
                d: function() {
        ...
        formatDate: function(e, t) {
            var a, n, r, i, s, o = this, l = "";
            if ("string" == typeof e && !(e = o.parseDate(e, t)))
                return null;
            if (e instanceof Date) {
                for (r = t.length,
                a = 0; a < r; a++)
                    "S" !== (s = t.charAt(a)) && "\\" !== s && (a > 0 && "\\" === t.charAt(a - 1) ? l += s : (i = o.parseFormat(s, e),
                    a !== r - 1 && o.intParts.test(s) && "S" === t.charAt(a + 1) && (n = parseInt(i) || 0,
...
const laravelValidation = {
    ...
    arrayRules: function(e) {
        const t = {}
          ...
          , n = a.arrayRulesCache;
        return -1 === e.name.indexOf("[") || (e.name in n || (n[e.name] = {}),
    ...
    setupValidations: function() {
        $.validator.addMethod("laravelValidation", (function(e, t, a) {
            ...
            $.each(s, (function(a, s) {
                const o = s[3] || -1 !== laravelValidation.implicitRules.indexOf(s[0])
                  , l = s[0]
                  , u = s[2];
                return !o && n.optional(t) ? (r = "dependency-mismatch",
                !1) : (r = void 0 !== laravelValidation.methods[l] && laravelValidation.methods[l].call(n, e, t, s[1], (function(a) {
                    if (n.settings.messages[t.name].laravelValidationRemote = i.originalMessage,
                    a) {
                ...
                !0 !== r ? (n.settings.messages[t.name] || (n.settings.messages[t.name] = {}),
        ...
        $.validator.addMethod("laravelValidationRemote", (function(e, t, a) {
            ...
            let i, s = !1, o = a[0][1], l = t.name, u = o[1], d = o[2];
            ...
            r.originalMessage = n.settings.messages[t.name].laravelValidationRemote,
            ...
            $.ajax($.extend(!0, {
                ...
                beforeSend: function(e) {
                    if ("get" !== $(n.currentForm).attr("method").toLowerCase() && u)
                ...
                if ("error" === i)
                    u = !1,
                    a = laravelValidation.helpers.parseErrorResponse(a);
                else {
                    if ("success" !== i)
                        return;
                    u = !0 === a || "true" === a
                }
                n.settings.messages[t.name].laravelValidationRemote = r.originalMessage,
                u ? (l = n.formSubmitted,
                n.prepareElement(t),
                n.formSubmitted = l,
                n.successList.push(t),
...
$.extend(!0, laravelValidation, {
    helpers: {
        ...
        fileinfo: function(e, t) {
            var a = e.value;
            return t = void 0 !== t ? t : 0,
            null !== e.files && void 0 !== e.files[t] && {
                file: a,
        ...
        parseTime: function(e, t) {
            var a = !1
              , n = new DateFormatter;
            if ("number" == typeof e && void 0 === t)
                return e;
            if ("object" === $.type(t)) {
                var r = this.getLaravelValidation("DateFormat", t);
                t = void 0 !== r ? r[1][0] : null
            }
            return null == t ? a = this.strtotime(e) : (a = n.parseDate(e, t)) && (a = Math.round(a.getTime() / 1e3)),
            a
        },
        guessDate: function(e, t) {
